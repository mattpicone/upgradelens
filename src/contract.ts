...
const COMMON_RESULT_PROPERTIES = {
  ...
  // Target discovery is intentionally non-authorizing. Keeping this field on
  // the shared envelope makes the edit gate explicit for every operation.
...
export const TARGET_OUTPUT_SCHEMA = {
  ...
  required: [
    ...
    "action_allowed", "candidates", "evidence", "coverage", "confidence", "freshness", "analysis_version",
  ],
  properties: {
    ...COMMON_RESULT_PROPERTIES,
    latest_stable: { type: ["string", "null"] },
...
export const OPERATION_CATALOG = [
  {
    ...
    outputExample: {
      ...
      recommended_target: "5.1.0",
      billing: { mode: "testnet", units: 1, price_usd: 0.01, trial_remaining: 0, network: BASE_SEPOLIA, payment_status: "settled" },
  ...
  },
  {
    ...
    outputExample: {
      next_action: "check_recommended_target",
      recommended_target: "4.21.2",
      action_allowed: false,
      billing: { mode: "testnet", units: 1, price_usd: 0.01, trial_remaining: 0, network: BASE_SEPOLIA, payment_status: "settled" },
      ecosystem: "npm",
      package: "express",
      ...
      candidates: [{ version: "4.21.2", decision: "review_required", requires_full_check: true, rationale: ["candidate requires check_dependency_upgrade before any dependency edit"] }],
      evidence: [],
      coverage: {},
      confidence: 0.9,
      freshness: "2026-08-31T00:00:00.000Z",
  ...
  },
  {
    ...
    outputExample: {
      next_action: "complete_migration_actions",
      recommended_target: "5.1.1",
      billing: { mode: "testnet", units: 1, price_usd: 0.01, trial_remaining: 0, network: BASE_SEPOLIA, payment_status: "settled" },
      decision: "review_required",
      action_allowed: false,
      risk_score: 35,
      ...
      freshness: "2026-08-31T00:00:00.000Z",
      analysis_version: CONTRACT_VERSION,
      migration_actions: [{ order: 1, action: "Review cited breaking changes.", evidence_ids: [] }],
      changelog_urls: [],
    },
